...
host = 'localhost'
ping_target = 'C'
host_port = 50052 #Port that the current Traffic Light is hosting....
ping_port = 50053 # Port that this traffic light is pinging....
time_gap = 30
...
def pingEcho():
    ...
    try:
        ...
        if rpc_error.code() == grpc.StatusCode.UNAVAILABLE:
            ...
            if fail_count >= 3:
                #Call the Cloud Services when failed to ping the target for more than 3 times
